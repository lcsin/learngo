/*
@see: https://entgo.io/zh/docs/getting-started
*/
package main
...
import (
	...
	"github.com/learngo/orm/ent/quickstart/ent"
	"github.com/learngo/orm/ent/quickstart/ent/car"
	"github.com/learngo/orm/ent/quickstart/ent/group"
	"github.com/learngo/orm/ent/quickstart/ent/user"
	"log"
	"time"
)

func main() {
	client, err := ent.Open("mysql", "root:root@tcp(10.225.137.237:3306)/learn_ent?parseTime=true")
	if err != nil {
